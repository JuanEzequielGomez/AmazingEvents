let contenedorDatosUpcoming = document.getElementById('contenedor-datos-upcomming');
...
function mostrarCartas(cartas) {
  ...
  if (cartas.length > 0) {
    ...
    contenedorDatosUpcoming.innerHTML = agregar;

    });
  } else {
    contenedorDatosUpcoming.innerHTML = `<div class="error"><img class="error-img" src="../assets/imgs/404_2.png" alt="error 404"></div>`;
